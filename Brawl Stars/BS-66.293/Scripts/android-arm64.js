...
const PepperKiller = {
    init() {
        try {
            Interceptor.replace(base.add(0xD42854), new NativeCallback(function() {
        ...
        Interceptor.attach(base.add(0xD438B8), function() { // Messaging::encryptAndWrite
