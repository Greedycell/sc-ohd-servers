# CR 1.9.0
Private server for Clash Royale 1.9.0 (2017) written on Node.js

## Requirements
* [Node.js](https://nodejs.org)

## Setup
1. Download the repository by zip or type this into the Terminal: `git clone https://github.com/Greedycell/CR-1.9.0.git`
