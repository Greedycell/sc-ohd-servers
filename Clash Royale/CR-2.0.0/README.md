# CR 2.0.0
A simple & lightweight private server for Clash Royale 2.0.0 (2017) written on Node.js

## Requirements
* [Node.js](https://nodejs.org)

## Setup
1. Download the repository by zip or type this into the Terminal: `git clone https://github.com/Greedycell/CR-2.0.0.git`
