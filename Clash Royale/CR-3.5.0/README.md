# CR 3.5.0
The world's first private server emulator for Clash Royale 3.5.0 (2021) written on Node.js

## Requirements
* [Node.js](https://nodejs.org)

## Setup
1. Download the repository by zip or type this into the Terminal: `git clone https://github.com/Greedycell/CR-3.5.0.git`
